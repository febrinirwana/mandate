  ...
  [
    {
      ...
      consequence:
        "Immediate app-level stop for this strategy hash. Irreversible for this mandate.",
    ...
    <div>
      ...
      <ul>
        {PATHS.map((p) => (
          <li
            key={p.key}
            className="flex flex-wrap items-center justify-between gap-x-6 gap-y-2 border-b border-rule py-4 last:border-b-0"
          >
